    ...
    <div class="navbar">
      ...
      <div class="navbar-right-container" style="display: flex;">
        <div class="navbar-menu-container">
          ...
          <a href="javascript:void(0)" class="navbar-link" @click="loginFlag = true" v-show="!userName">Login</a>
          <span v-if="userName">Welcome,&nbsp{{userName}}!</span>
          <a href="javascript:void(0)" class="navbar-link" @click="logout()" v-if="userName">Logout</a>
        ...
        <div class="md-content">
          <div class="confirm-tips">
            <div class="error-wrap">
              <span class="error error-show" v-show="erroFlag">user name or password is invalid</span>
            </div>
            <ul>
              <li class="regi_form_input">
                <i class="icon IconPeople"></i>
                <input type="text" tabindex="1" name="loginname" v-model="userNamePop" class="regi_login_input regi_login_input_left" placeholder="User Name" data-type="loginname">
              </li>
              <li class="regi_form_input noMargin">
                <i class="icon IconPwd"></i>
                <input type="password" tabindex="2" name="password" v-model="userPasswordPop" class="regi_login_input regi_login_input_left login-input-no input_text" placeholder="Password" @keyup.enter="login">
              </li>
            </ul>
          </div>
...
export default {
  ...
  methods: {
    login() {
      axios
        .post('/api/user/login', {
          userName: this.userNamePop,
          userPwd: this.userPasswordPop
        })
        .then((res) => {
